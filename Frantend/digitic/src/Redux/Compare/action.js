...
const getcompare=(dispatch)=> {
    ...
    return axios.get('https://shift-raven.cyclic.app/compare/',{
        headers:{
...
const postcompare=(data)=>(dispatch)=>{
    ...
    return axios.post(`https://shift-raven.cyclic.app/compare/newpost/`,data,{
        headers:{
            "Authorization":`Bearer ${localStorage.getItem("token_key")}`
        }
    })
...
const deletecompare=(id)=>(dispatch)=>{
    ...
    return axios.delete(`https://shift-raven.cyclic.app/compare/delete/${id}`,{
        headers:{
            "Authorization":`Bearer ${localStorage.getItem("token_key")}`
        }
    })
